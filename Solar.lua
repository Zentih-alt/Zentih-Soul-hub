...
function Library.CreateWindow(config)
    ...
    function WindowAPI.AddTab(name, group)
        ...
        do local c = Instance.new("UICorner") c.CornerRadius = UDim.new(0,5) c.Parent = btn end

        local tabObj = { scroll = scroll, btn = btn, layout = layout, _order = 0, name = name, elements = {}, groupColor = groupList[group].color }
        ...
        function tabObj:AddToggle(title, desc, callback, flag)
            ...
            sw.Parent = row
            do local c = Instance.new("UICorner") c.CornerRadius = UDim.new(0,7) c.Parent = sw end
            ...
            knob.Parent = sw
            do local c = Instance.new("UICorner") c.CornerRadius = UDim.new(0,4) c.Parent = knob end
